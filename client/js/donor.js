...
if (document.getElementById("profileForm")) {
  document.getElementById("profileForm").addEventListener("submit", async (e) => {
    ...
    try {
      const res = await fetch("https://blood-bank-system-1-n8z7.onrender.com/api/donor/profile", {
        method: "POST",
        headers: {
...
if (document.getElementById("donateForm")) {
  document.getElementById("donateForm").addEventListener("submit", async (e) => {
    ...
    try {
      const res = await fetch("https://blood-bank-system-1-n8z7.onrender.com/api/donor/donate", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
...
if (document.getElementById("donationTable")) {
  fetch(`https://blood-bank-system-1-n8z7.onrender.com/api/donor/history?email=${user.email}`, {
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
    },
  })
